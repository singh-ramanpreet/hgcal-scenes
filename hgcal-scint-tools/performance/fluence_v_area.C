...
void fluence_v_area(const char* fname) {
  ...
  c1->Divide(1,2);
  c1->cd(1);
  TH1* theHisto=new TH1D("hist",";1 MeV-equiv n/cm^2;area [m^{2}] per 10 krad",40,0.0,1e14);
  TH1* theHistoI=new TH1D("ihist",";;Fraction of area below",40,0.0,1e14);
